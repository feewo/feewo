# Привет! Добро пожаловать в мой Github ( • ᴗ - ) ✧
 ...
 ![HTML5](https://img.shields.io/badge/HTML5-black?style=flat-square&logo=HTML5&labelColor=black) ![CSS3](https://img.shields.io/badge/CSS3-black?style=flat-square&logo=CSS3&labelColor=black) ![JS](https://img.shields.io/badge/JS-black?style=flat-square&logo=JavaScript&labelColor=black) ![SASS](https://img.shields.io/badge/SASS-black?style=flat-square&logo=SASS&labelColor=black) ![Vue.js](https://img.shields.io/badge/Vue.js-black?style=flat-square&logo=Vue.js&labelColor=black)
...
## Опыт работы ( -_•)╦̵̵̿╤─
 ...
 ### Laravel:
  Разработала [сайт-тренажер по SQL для Котласского речного училища](http://tren-kotlass.1gb.ru) с использованием PHP-фреймворка Laravel.
 ### Golang:
 ...
 ### Текущие проекты
  В данный момент разрабатываю адаптивную frontend-часть для различных крупных и малых проектов
